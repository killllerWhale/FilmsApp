...
class MovieSearchPagingSource(private val retrofitParse: RetrofitParse, private val query: String) : PagingSource<Int, MovieItem>() {

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, MovieItem> {
        return try {
            val page = params.key ?: 1
            val response = retrofitParse.getSearchMovies(query,page)
